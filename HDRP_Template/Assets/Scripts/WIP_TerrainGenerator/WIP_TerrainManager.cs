...
namespace VM.TerrainGenerator
{
    ...
    public class WIP_TerrainManager : MonoBehaviour
    {
        [Header("Settings")]
        ...
        private void _RenderMesh()
        {
            ...
            for (int i = 0, z = 0; z <= this._zSize; z++)
            {
                ...
                {
                    this._vertices.Add(new Vector3(x, Random.Range(-1, 1), z));
                    this._colors.Add(x % 5 == 0 ? Color.white : Color.red);
